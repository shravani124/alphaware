...
<body>
	...
	<br>
		...
		<?php
			if (isset($_POST['add']))
				...
				$q1 = mysqli_query($conn, "INSERT INTO product ( product_id,product_name, product_price, product_image, category)
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>CNC</h2></center></div>
			<br />
